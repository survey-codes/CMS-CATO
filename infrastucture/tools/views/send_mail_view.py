...
from infrastucture.messengerservice.MessengerServiceSendgrid import MessengerServiceSendgrid
from infrastucture.tools.forms.select_mail_form import SelectMailForm
from infrastucture.tools.models import UserPqrd
from infrastucture.tools.views.base_view import BaseView
from infrastucture.utilities.tasks.send_task import SendTask


class SendMailView(BaseView):
    __USERS_KEY = "users"
    __user_pqrd_service = UserPqrdServiceBorrador()
    __send_task = SendTask(MessengerServiceSendgrid())
    __request = None
