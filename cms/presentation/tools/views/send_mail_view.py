...
from cms.domain.utilities.tasks.send_task import SendTask
from cms.infrastructure.data_access.entities.tools.models import UserPqrd
from cms.presentation.constants import IDS, MAIL_KEY
from cms.presentation.tools.forms.select_mail_form import SelectMailForm
from cms.presentation.tools.views.base_view import BaseView
