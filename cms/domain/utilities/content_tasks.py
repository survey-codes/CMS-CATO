...
def _get_galleries(post_id):
    ...
    from cms.infrastructure.data_access.entities.contents.models.posts import PostGallery
...
def page_update_jsonfield(page_id):
    ...
    from cms.infrastructure.data_access.entities.contents.models.pages import PageLanguage
    try:
...
def section_update_jsonfield(section_id):
    ...
    from cms.infrastructure.data_access.entities.contents.models.posts import PostSettings
    try:
...
def post_update_jsonfield(post_id):
    ...
    from cms.infrastructure.data_access.entities.contents.models.posts import PostLanguage
    try:
